 ...
 */
public class RecyclerViewFragmentMovieNowPlaying extends Fragment implements LoaderManager.LoaderCallbacks<Cursor> {

    // Constant
    private static final String LOG_TAG = RecyclerViewFragmentMovieNowPlaying.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        // Set the Adapter.
        holder.hRecyclerView.setAdapter(mNowPlayingAdapter);

        // Set the click listener.
        mNowPlayingAdapter.setOnItemClickListenerNowPlaying(onItemClickListener);
     ...
     */
    public NowPlayingRecyclerViewAdapter.OnItemClickListenerNowPlaying onItemClickListener =
            new NowPlayingRecyclerViewAdapter.OnItemClickListenerNowPlaying() {
                @Override
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        switch (loader.getId()) {
            case LOADER_IDE_ONE:
                ...
                mNowPlayingAdapter.swapCursor(dataModelMovie);
                break;
        }
    }
